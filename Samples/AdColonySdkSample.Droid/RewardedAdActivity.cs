...
namespace AdColonySdkSample.Droid
{
    ...
    public class RewardedAdActivity : AppCompatActivity, IAdColonyRewardListener
    {
        private const string APP_ID = "app185a7e71e1714831a49ec7";
        private const string ZONE_ID = "vz1fd5a8b2bf6841a0a4b826";
        ...
        {
            Log.Debug(TAG, "onReward");
        }

        private class MyAdColonyInterstitialListener : AdColonyInterstitialListener
        {
            private readonly RewardedAdActivity _activity;

            public MyAdColonyInterstitialListener(RewardedAdActivity activity)
            {
                _activity = activity;
            }
